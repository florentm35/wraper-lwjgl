...
public enum EnumKey {
    ...
    EnumKey(int keyValue) {
        this.keyValue = keyValue;
    }

    private final int keyValue;

    public static EnumKey valueOf(int lwjqlKeyValue) {
        ...
        throw new LwjglRuntimeException(String.format("Key %d cannon't be found", lwjqlKeyValue));
    }
